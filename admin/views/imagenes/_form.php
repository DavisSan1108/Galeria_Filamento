	...
	if(isset($_GET['insert'])){
		if($_GET['insert'] == 'true'){
			echo '<div class="alert alert-success" role="alert">
					 <i class="fa fa-check-square-o" aria-hidden="true"></i>  Registro guardado con exito! ('.Html::a("Ver imagenes", $url = ['imagenes/update&id='.$_GET['id']], $options = ['class'=>'']).')
				 </div>';
		}
	}
...
<div style="clear: both;"></div>
				...
				<div class="col-sm-4 float-left  pleft-0">
					<?= $form->field($model, 'urlImagen')->textInput(['maxlength' => true]) ?>
				</div>
				<div class="col-sm-4 float-left  pleft-0">
...
<div class="col-sm-12  pleft-0">
    <div class="form-group">
		<?= Html::submitButton('<i class="fa fa-check"></i> &nbsp; Guardar', ['class' => 'btn btn-success']) ?>
    </div>
</div>
