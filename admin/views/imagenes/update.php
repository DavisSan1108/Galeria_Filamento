		...
		<div class="ml-auto">
			<div class="page-header-breadcrumb">
				<?php 		
						...
						echo Html::a($mAltaGral, $url = ['imagenes/create'], $options = ['class'=>'btn btn-primary btn-xs menuBotones']);
					
						$mUpdateGral = '<i class="icon-note"></i>	Editar';
						echo Html::a($mUpdateGral, $url = ['imagenes/update&id='.$_GET['id']], $options = ['class'=>'btn btn-primary btn-xs menuBotones active']);
					?>
                     ...
                     success:function(bool){
                        ...
                        if (bool == true){
                            alertify.success('<span style="color: #FFFFFF;"><i class="fa fa-trash" aria-hidden="true"></i> &nbsp;&nbsp;Registro eliminado<br> espere un momento ...</span>', 2 , function (){
								window.location.href = "index.php?r=imagenes/index&del=true"; 
							}); 
                        }else{
