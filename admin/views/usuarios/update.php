		...
		<div class="ml-auto">
			<div class="page-header-breadcrumb">
				<?php 		
						...
						echo Html::a($mUpdateGral, $url = ['usuarios/update&id='.$_GET['id']], $options = ['class'=>'btn btn-primary btn-xs menuBotones active']);
				
						$mUpdateGral = '<i class="icon-lock"></i>	Contraseña';
						echo Html::a($mUpdateGral, $url = ['usuarios/pass&id='.$_GET['id']], $options = ['class'=>'btn btn-primary btn-xs menuBotones ']);
					?>
