		...
		<div class="ml-auto">
			<div class="page-header-breadcrumb">
				<?php 		
						...
						echo Html::a($mInicioGral, $url = ['recetas/index'], $options = ['class'=>'btn btn-primary btn-xs  menuBotones']);
						...
						echo Html::a($mUpdateGral, $url = ['recetas/update&id='.$_GET['id']], $options = ['class'=>'btn btn-primary btn-xs menuBotones active']);
					?>
                     ...
                     success:function(bool){
                        ...
                        if (bool == true){
                            alertify.success('<span style="color: #FFFFFF;"><i class="fa fa-trash" aria-hidden="true"></i> &nbsp;&nbsp;Registro eliminado<br> espere un momento ...</span>', 2 , function (){
								window.location.href = "index.php?r=recetas/index&del=true"; 
							}); 
                        }else{
